...
/**
 * @author
 * Coincidental cohension: MD5- phương thức mã hóa không liên quan chức năng authentication
 */

/**
 * Vi phạm nguyên lý SRP
 * Lớp sử dụng xác thực nhưng lại chứa các phương thức validate, phương thức algo md5
 * không làm đúng nhiệm vụ của lớp, cần tách các phương thức ngoài nhiệm vụ của lớp sang các lớp khác
 */
